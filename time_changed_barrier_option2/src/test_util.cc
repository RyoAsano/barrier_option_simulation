...
void BlackScholesTimeChangedHittingTimeLinearCase(double volatility, double brownian_bridge_initial_value,
    ...
    *asset_price_process_ptr=brownian_bridge_initial_value+(brownian_bridge_goal_value-brownian_bridge_initial_value)*current_time/brownian_bridge_goal_time;
    *barrier_hitting_time_ptr=current_time/(volatility*volatility*brownian_bridge_initial_value*
                                (brownian_bridge_initial_value+(brownian_bridge_goal_value-brownian_bridge_initial_value)*current_time/brownian_bridge_goal_time));
}
}//namespace test_util
